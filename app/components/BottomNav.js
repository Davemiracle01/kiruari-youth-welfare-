...
const NAV = [
  ...
  { key: 'announcements', label: 'Notice', icon: '📢', href: '/announcements' },
...
export default function BottomNav() {
  ...
  return (
    <div style={{
      ...
      background: '#122018', borderTop: '1px solid #2D6A4F33',
        ...
        return (
          <Link key={n.key} href={n.href} style={{ textDecoration: 'none' }}>
            <button style={{
              ...
              alignItems: 'center', gap: 4, cursor: 'pointer', padding: '4px 16px',
              opacity: isActive ? 1 : 0.45,
            }}>
              <span style={{ fontSize: 22 }}>{n.icon}</span>
              <span style={{
                fontFamily: "'Lato', sans-serif", fontSize: 11, fontWeight: 700,
                color: isActive ? '#52B788' : '#556B5A',
                letterSpacing: 0.5,
              }}>{n.label}</span>
